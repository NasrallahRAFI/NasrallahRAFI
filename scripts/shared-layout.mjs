...
<p class="text-sm theme-text-muted">&copy; 2026 <span>Rafi Nasrallah</span> | ${french ? 'Doctorant &amp; Ing&eacute;nieur d’&Eacute;tat — Syst&egrave;mes embarqu&eacute;s, IoT &amp; Smart BMS' : 'PhD Researcher &amp; Electrical Engineer — Embedded Systems, IoT &amp; Smart BMS'}</p>
